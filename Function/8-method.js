...
console.log('obj1.d ec.name = ' + obj1.dec.name);  

console.log('obj.fn1(5) = ' + obj1.fn1(5));
console.log('obj.sum(1, 3) = ' + obj1.sum(1, 3));
console.log('obj.max(8, 6) = ' + obj1.max(8, 6));

console.log('obj.pow(8, 6) = ' + obj1.pow(8, 6));
